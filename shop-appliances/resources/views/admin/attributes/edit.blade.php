        ...
        <div class="card-body">
            <form action="{{ route('admin.attributes.update', $attribute) }}" method="POST">
                ...
                <div class="mb-3" id="options-container" style="display: none;">
                    ...
                    <div id="options-list">
                        @if(old('options', $attribute->options))
                            @foreach(old('options', $attribute->options) as $option)
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" 
                               ...
                               {{ old('is_highlight', $attribute->is_highlight) ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_highlight">Highlight</label>
                    </div>
                </div>

                <div class="mb-3" id="highlight-color-container" style="display: {{ old('is_highlight', $attribute->is_highlight) ? 'block' : 'none' }};">
                    ...
                    <select class="form-select @error('highlight_color') is-invalid @enderror" 
                        ...
                        <option value="red" {{ old('highlight_color', $attribute->highlight_color) == 'red' ? 'selected' : '' }}>Red</option>
                        <option value="blue" {{ old('highlight_color', $attribute->highlight_color) == 'blue' ? 'selected' : '' }}>Blue</option>
                        <option value="green" {{ old('highlight_color', $attribute->highlight_color) == 'green' ? 'selected' : '' }}>Green</option>
                        <option value="yellow" {{ old('highlight_color', $attribute->highlight_color) == 'yellow' ? 'selected' : '' }}>Yellow</option>
                        <option value="orange" {{ old('highlight_color', $attribute->highlight_color) == 'orange' ? 'selected' : '' }}>Orange</option>
                        <option value="purple" {{ old('highlight_color', $attribute->highlight_color) == 'purple' ? 'selected' : '' }}>Purple</option>
                        <option value="pink" {{ old('highlight_color', $attribute->highlight_color) == 'pink' ? 'selected' : '' }}>Pink</option>
                    </select>
